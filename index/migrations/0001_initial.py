# Generated by Django 2.2.5 on 2019-11-13 16:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song_singer', models.CharField(max_length=50, verbose_name='歌手名称')),
                ('song_time', models.CharField(max_length=10, verbose_name='歌曲时长')),
                ('song_album', models.CharField(max_length=50, verbose_name='歌曲专辑')),
                ('song_languages', models.CharField(max_length=20, verbose_name='语种')),
                ('song_type', models.CharField(max_length=20, verbose_name='歌曲类型')),
                ('song_release', models.CharField(max_length=20, verbose_name='发行时间')),
                ('song_img', models.CharField(max_length=20, verbose_name='歌曲图片')),
                ('song_lyrics', models.CharField(default='暂无歌词', max_length=1000, verbose_name='歌词')),
