...
class Song(models.Model):
    ...
    song_singer = models.CharField('歌手名称', max_length=50)
    song_time = models.CharField('歌曲时长', max_length=10)
    song_album = models.CharField('歌曲专辑', max_length=50)
    ...
    song_lyrics = models.CharField('歌词', max_length=1000, default='暂无歌词')
